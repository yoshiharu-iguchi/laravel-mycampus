...
class TransportRequest extends Model
{
    use HasFactory;
    protected $fillable=[
        'student_id','facility_id','from_station_name','to_station_name','travel_date','dep_time','arr_time','fare_yen','seat_fee_yen','total_yen','search_url','route_memo','status','approved_by','approved_at','admin_note',];
