...
class SubjectFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        '形態機能学Ⅰ～Ⅳ','代謝栄養学Ⅰ','代謝栄養学Ⅱ','病理学','微生物学','疾病論Ⅰ','疾病論Ⅱ','疾病論Ⅲ','疾病論Ⅳ','疾病論Ⅳ','薬理学Ⅰ','薬理学Ⅱ','看護臨床判断の基礎','保健医療学','関係法規','社会福祉論Ⅰ','社会福祉論Ⅱ',
        ...
        'year'         => now()->year,
        'term'         => fake()->randomElement(['前期','後期','通年']),
        'category'     => $this->faker->randomElement(['必修','選択']),
