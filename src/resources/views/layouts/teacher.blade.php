...
<li class="nav-item">
<a class="nav-link {{ request()->routeIs('teacher.dashboard') || request()->routeIs('teacher.home') ? 'active' : '' }}" href="{{ route('teacher.dashboard') }}">
<i class="bi bi-house-door"></i> ホーム
</a>
</li>
<li class="nav-item">
<a class="nav-link {{ request()->routeIs('teacher.enrollments.*') ? 'active' : '' }}" href="{{ route('teacher.enrollments.index') }}">
<i class="bi bi-people"></i> 履修
</a>
</li>
<li class="nav-item">
<a class="nav-link {{ request()->routeIs('teacher.attendances.*') ? 'active' : '' }}" href="{{ route('teacher.attendances.index') }}">
